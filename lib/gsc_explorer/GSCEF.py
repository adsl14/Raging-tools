...
def initialize_gsce(main_window):
    ...
    for i in range(1, 21):
        gsac_data.pointers.append(create_pointer_data_info(b'\x01', 15, 11, b'\x00', [[b'\x0A', i, b'\x00'], [b'\x0A', 0, b'\x00'], [b'\x0A', 0, b'\x00'], [b'\x0A', 0, b'\x00'], [b'\x0A', 0, b'\x00'],
                                                                                     [b'\x0A', 0, b'\x00'], [b'\x0A', 4294967295, b'\x00'], [b'\x0A', 100, b'\x00'], [b'\x0A', 27, b'\x00'],
...
def listen_events_logic(main_window, flag):
    ...
    if flag:
        ...
        main_window.damaged_partner_costume.toggled.connect(lambda: on_partner_damaged_costume(main_window))
        ...
        try:
            ...
            # Set the partner battle damaged
            main_window.damaged_partner_costume.toggled.disconnect()
