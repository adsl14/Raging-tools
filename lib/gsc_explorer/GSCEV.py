...
class GSCEV:
    ...
    path_gsc_breakdown_json = os.path.join("lib", "gsc_explorer", "resources", "GSC_RB1_breakdown.json")
    path_gsc_breakdown_html = os.path.join("lib", "gsc_explorer", "resources", "GSC_RB1_breakdown.html")
    ...
    # Store gsc json object
    gsc_breakdown_json = None
